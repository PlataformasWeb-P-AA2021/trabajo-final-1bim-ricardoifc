...
with open('data/Listado-Instituciones-Educativas.csv', 'r') as csv_file:
    ...
    for l in lista:
        ...
        l['Número de estudiantes'], l['Número de docentes']]) not in datos:
            ...
            # Agregar los datos
            agregar = Establecimiento(codigo=l['Código AMIE'],codParroquia=l['Código División Política Administrativa  Parroquia'],
            ...
            modalidad=l['Modalidad'], jornada=l['Jornada'], acceso=l['Acceso (terrestre/ aéreo/fluvial)'],
            numEstudiantes=l['Número de estudiantes'], NumDocentes=l['Número de docentes'])
            session.add(agregar)
